...
namespace App\Filament\Resources\Awpfs\Schemas;
        ...
        return $schema
            ->components([
                Section::make('Basic Information')
                    ->description('General details about the AWPF course')
                    ->columnSpanFull()
                    ->schema([
                        TextInput::make('name')
                            ->label('Course Name')
                ...
                Section::make('Course Schedule')
                    ...
                    ->schema([
                        Repeater::make('schedules')
                            ...
                            ->reorderable()
                            ->collapsible()
                            ->itemLabel(fn (array $state): ?string => isset($state['day_of_week'], $state['start_time']) && $state['day_of_week'] instanceof DayOfWeek
